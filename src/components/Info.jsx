      ...
      <div>
        ...
        <ListGroup>
          ...
          <List>
            ...
            <ListItem>
              <b>Currencies:</b>{currencies.map(currencie => (<span key={currencie.code}> {currencie.name} </span>))}
            </ListItem>
            <ListItem>
              <b>Languages:</b>{languages.map(language => (<span key={language.name}> {language.name}</span>))}
            </ListItem>
          </List>
        </ListGroup>
        <Meta>
